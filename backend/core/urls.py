...
urlpatterns = [
    ...
    path("learning/questions/<int:pk>/run-code/", TopicQuestionRunCodeView.as_view(), name="learning-question-run-code"),
    ...
    path("learning/topics/<int:pk>/practice/finish/", TopicPracticeFinishView.as_view(), name="learning-topic-finish"),
