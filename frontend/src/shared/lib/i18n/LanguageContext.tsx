    ...
    en: {
        ...
        pages: {
            courses: {
                ...
                catalogNotFoundTitle: 'Courses not found',
                catalogNotFoundText: 'The course catalog could not be loaded. The page may be unavailable or the server did not return courses.',
                ...
                noFilteredCourses: 'No courses match these filters.'
            },
            learning: {
                title: 'My Learning',
                ...
                averageSuccess: 'Average user success',
                ...
                runCode: 'Run',
                runningCode: 'Running',
                codeEditor: 'Python code',
                output: 'Output',
                stderr: 'Errors',
                noOutput: 'No output',
                failedToRunCode: 'Failed to run code.',
                ...
                timedTestInProgress: 'Timed test in progress. Navigation is locked until you finish.',
            ...
            teacher: {
                ...
                expectedOutputPlaceholder: 'Exact stdout, including line breaks',
                maxScore: 'Max Score',
                options: 'Options',
    ...
    sk: {
        ...
        pages: {
            courses: {
                ...
                catalogNotFoundTitle: 'Kurzy sa nenašli',
                catalogNotFoundText: 'Katalóg kurzov sa nepodarilo načítať. Stránka môže byť nedostupná alebo server nevrátil kurzy.',
                catalogEmptyTitle: 'Katalóg je prázdny',
                ...
                stars: 'hviezdičiek',
                filters: 'Filtre kurzov',
                searchByTitle: 'Hladat podla nazvu',
                searchPlaceholder: 'Hladat kurzy...',
                clearFilters: 'Vymazat filtre',
                noFilteredCourses: 'Ziadne kurzy nezodpovedaju filtrom.'
            },
            learning: {
                ...
                accuracy: 'Presnosť',
                time: 'Čas',
                communityStats: 'Statistika pouzivatelov',
                averageSuccess: 'Priemerna uspesnost',
                completedUsers: 'Dokonceni pouzivatelia',
                passRate: 'Miera uspesnosti',
                progress: 'Pokrok:',
                topics: 'témy',
                readMore: 'Čítať viac',
                ...
                runCode: 'Spustiť',
                runningCode: 'Spúšťam',
                codeEditor: 'Python kód',
                output: 'Výstup',
                stderr: 'Chyby',
                noOutput: 'Žiadny výstup',
                failedToRunCode: 'Spustenie kódu zlyhalo.',
                ...
                timedTestInProgress: 'Časovaný test prebieha. Navigácia je uzamknutá, kým test nedokončíte.',
            ...
            teacher: {
                ...
                pythonCode: 'Python kód',
                expectedOutput: 'Očakávaný výstup',
                expectedOutputPlaceholder: 'Presný stdout vrátane zalomení riadkov',
